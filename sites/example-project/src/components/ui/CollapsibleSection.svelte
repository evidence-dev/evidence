   ...
   <div class=collapsible>
    <div class=folder class:selected="{$page.path === "/" + folder}" >
       <button class=expandable aria-expanded={expanded} on:click={() => expanded = !expanded}>
    	<svg style="tran"  width="15" height="15" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
...
.folder:hover, .content-item:hover {
