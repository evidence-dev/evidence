...
test("getColumnUnitSummary returns correct values with real valued nubmer array", () => {
  const data = [
...
test("getColumnUnitSummary returns correct values when there are undefined and null elements in numbered data series", () => {
  const data = [
...
test("getColumnUnitSummary returns correct values with a string data series", () => {
  const data = [
    { column1: "foo", column2: 3 },
    { column1: "bar", column2: null },
    { column1: "dar", column2: undefined },
