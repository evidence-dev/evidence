...
test("getColumnUnitSummary returns undefined for none numeric types", () => {
  const data = [
...
test("getColumnUnitSummary returns correct values with typical example", () => {
  const data = [
...
test("getColumnUnitSummary returns correct values when there are undefined and null elements", () => {
  const data = [
    { column1: "foo", column2: 3 },
