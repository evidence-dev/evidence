...
<DataTable data={orders_with_comparisons} rowNumbers=true search=true rowLines=true rowShading=false/>
...
<DataTable data={orders_by_category} rows=40 rowNumbers=true rowShading=true>
  <Column id=month />
  <Column id=category />
  <Column id=sales_usd0k contentType=delta />
