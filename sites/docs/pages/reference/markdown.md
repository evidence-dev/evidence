...
<PropListing
    name="breadcrumb"
    description="Specify a query that returns a column named breadcrumb. The query can use $&#123params.my_param&#125 to reference the URL parameters for the page. E.g. `breadcrumb: &quot;select customer_name as breadcrumb from customers_table where customer_id=$&#123params.customer_id&#125`&quot;"
/>
