...
```sql commands
select '<code>npx degit evidence-dev/template my-app</code>' as "CLI", '<code>Evidence: New App</code>' as "VS Code", 'Create a new app from the template' as "Description", 0 as row_num UNION ALL
