...
<PointMap data={la_locations} lat=lat long=long value=sales valueFmt=usd pointName=point_name height=200 basemap={`https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.{ext}`}/>
...
### Link Drilldown
Pass in a `link` column to enable navigation on click of the point
...
options="column name"
>
Column in the data that specifies the area each point belongs to.
</PropListing>
...
>
Configuration for tooltips associated with each point.
</PropListing>
