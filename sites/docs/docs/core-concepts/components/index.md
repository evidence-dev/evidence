...
Charts can include reference lines and reference areas using the `ReferenceLine` and `ReferenceArea` components. These components are used within a chart component like so:
