...
<tr>	<td>chartAreaHeight</td>	<td>Minimum height of the chart area (excluding header and footer) in pixels. Adjusting the chart height will affect all viewport sizes and may impact the mobile experience for your users. If you wish to have a horizontal bar chart maintain a dynamic height based on its contents, do not supply a chartValueHeight or it will override any calculated height.</td>	<td class='tcenter'>-</td>	<td class='tcenter'>number</td>	<td class='tcenter'>180</td>	</tr>
</table>
