...
<div class="grid">
	{#if $page.path !== '/settings'}
		<div class="header-bar">
			<Header {menu} {folderList} url="https://github.com/evidence-dev"/>
		</div>
		<div class="header-button" class:open>
			<Hamburger bind:open/>
		</div>
	{/if}
	<Sidebar bind:open {menu} {folderList} projectTitle="Evidence Docs"/>
	<main in:blur|local>
...
<footer>
	This is footer content like links to the main site
</footer>
