...
1. In the `packages/core-components` folder, run `pnpm run dev:core-components`
1. In another terminal, in the project root folder, run `pnpm run dev:example-project`
