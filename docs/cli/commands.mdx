...
Show or change anonymous usage reporting. See [Telemetry](/cli#telemetry) for what is sent.

```bash
evidence telemetry            # same as status
evidence telemetry status
evidence telemetry disable
evidence telemetry enable
```
