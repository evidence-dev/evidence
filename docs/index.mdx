...
keywords:
  ...
  - BI tool
  - business intelligence and analytics (ABI)
  - data products
  - dashboards
  - reporting platform
  - analytics platform
...
Evidence is a business intelligence and analytics (ABI) platform for building data products with SQL, markdown, and AI. Use it as a BI tool to write SQL reports, build dashboards, and publish an analytics platform your team can explore. It's a reporting platform for data visualization — one of the business intelligence tools your whole organization can use. Evidence comes in two parts: an open-source framework you can run yourself, and a hosted platform built on top of it.
