...
Themes let you customize the appearance of your Evidence projects — chart colors, backgrounds, and color scales. Because themes match any brand and published reports surface your organization's logo and name rather than Evidence branding, Evidence works well as a white label reporting tool. A theme is defined in version-controlled files alongside your content, so changes are reviewable in pull requests and roll back the same way your pages do.
