...
Scheduled reports let you deliver a published report to your team on a regular cadence — or send a one-off copy on demand. Evidence is one of the business intelligence reporting tools that render each run to a PDF — a standard bi software pdf export — and deliver it by **email** to specific people or a group, or post it to a **Slack channel**. Among bi reporting platforms that support scheduled delivery, this puts recurring report distribution directly where your team already works.
...
Email is the default destination. You can schedule report email delivery to specific users or a group, set a subject, and optionally add a personal message that appears alongside the report.

### Slack

Posting a scheduled report to Slack gives your team a slack bi surface, with the report landing in the channel they already work in. To post a report to Slack, your organization must have a Slack workspace connected under **Settings → Integrations → Slack**. Then:
