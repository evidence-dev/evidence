...
description: 'Learn how to manage your Evidence projects using BI as code with Git.'
keywords:
  - git
  - version control
  - GitHub integration
...
Evidence projects correspond to Git repositories. This means you can use Git for source control and analytics versioning — treating your reports and queries as BI as code that's versioned, reviewed, and rolled back the same way application code is. Every commit adds to a business intelligence history you can inspect, branch, and replay, turning your reporting workflow into a business intelligence pipeline that flows through the same pull-request and publish cycle as software. This is bi ops for analytics: the same GitOps practices applied to BI content.
