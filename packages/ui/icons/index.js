...
const builder = new ThemeBuilder({
	sources: {
		...
		// collectFromDir: { 'custom-icons': 'default' }, //* use this if icon themes are bound to the overlying directory (e.g. outline/cake.svg, fill/cake.svg).
...
builder.build(); //* if neither collectFromDir or collectFromSuffix are defined, a already populated themes directory with at least a default theme is necessary (see example in this template)
