...
export class EvidenceMap {
     ...
     */
    addArea(item, name, feature, areaOptions, selectedAreaOptions, onclick, setInput, unsetInput, link) {
     ...
     */
    addCircle(item, name, circleOptions, selectedOptions, coords, onclick, setInput, unsetInput, link) {
        if (!Leaflet) throw new Error('Leaflet is not yet available');
