...
<Story name="Multiple Series, X null all instances of one">
	<ScatterPlot x="x" y="y" series="series" data={brokenData} legend sort={false} />
	...
	Chart!
	<ScatterPlot data={brokenData} y="y" series="series" />

	<ScatterPlot x="x" y="y" series="series" data={[]} legend sort={false} />
</Story>
