...
<script>
	...
	import InnerRadarChart from './InnerRadarChart.svelte';
...
<QueryLoad {data} let:loaded>
	...
	<InnerRadarChart {...spreadProps} data={Query.isQuery(loaded) ? Array.from(loaded) : loaded}>
		<slot />
	</InnerRadarChart>
</QueryLoad>
