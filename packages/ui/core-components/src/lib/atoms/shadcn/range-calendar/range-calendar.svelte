		...
		<RangeCalendar.Heading class="flex items-center justify-between font-normal">
			...
			>
				<SelectPrimitive.Trigger
					...
					class="text-sm px-2 py-1 rounded-tl rounded-bl border-r border-base-300 transition-colors duration-200 hover:bg-base-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-base-content"
				>
			...
			>
				<SelectPrimitive.Trigger
					...
					class="px-2 py-1 rounded-tr rounded-br text-sm hover:bg-base-200 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-base-content"
				>
