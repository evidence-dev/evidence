...
export type Format = {
    ...
    _autoFormat: {
        autoFormatFunction?: <T extends EvidenceTypeUnion>(value: T, format?: Format, columnUnitSummary?: ColumnUnitSummary) => T | string,
...
export type ColumnUnitSummary = ReturnType<typeof import("./getColumnExtents.js").getColumnUnitSummary>;
