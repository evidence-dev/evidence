export const postgres = {
    package: {
        package: {
            package: {
                evidence:{ components: false, databases: ["pg", "postgres"], exports: {".": ""}, name: "@fake-psql", main: "index.cjs"}
            },
            path: ""
        },
        options: {
            ...
            ssl: {
                ...
                children: {
                    [true]: { // TODO: Test that this works properly
                        sslmode: {
                            title: 'SSL Mode',
                            type: 'select',
                            secret: false,
...
export const duckdb = {
    package: {
        package: {  
            package: {
                evidence: {components: false, databases: ["ddb", "duckdb"]}, exports: {".": ""}, name: "@fake-duckdb", main:"index.cjs"
            },
            path: ""
        },
        options: {
