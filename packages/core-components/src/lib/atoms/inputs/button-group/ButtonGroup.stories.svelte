...
<Meta title="Atoms/inputs/ButtonGroup" component={ButtonGroup} argTypes={{}} args={{ title: "Group of buttons", name: "buttonGroup" }} />
...
<Story name="Query-Based Entries" let:args>
    <div class="mb-8">
        <ButtonGroup {...args}>
            <ButtonGroupItem label="Option 1" value={1} />
            <ButtonGroupItem label="Option 2" value={2} />
