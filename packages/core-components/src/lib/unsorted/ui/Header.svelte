			...
			<div class="relative">
				<Menu class="outline-none">
					...
					<MenuItems class="absolute top-12 right-0 z-50 flex max-w-min outline-none">
						<div
							class="shrink w-48 border border-gray-300 rounded-md bg-white/80 backdrop-blur-md px-2 py-2 text-sm leading-6 text-gray-950 shadow-xl"
						>
							<MenuItem
								let:active
								on:click={() => {
							...
							>
								<div
									class="w-full text-left py-1 px-1 hover:bg-gray-100/80 rounded-md cursor-pointer"
									class:active
								>
									Print
								</div>
