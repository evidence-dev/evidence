...
{:else}
	<span
		class="group inline-flex items-center relative cursor-help cursor-helpfont-sans px-1 border border-error-200 py-[1px] bg-error-50 rounded"
	>
		<span class="inline font-sans font-medium text-xs text-error-600">error</span>
		<span
